...
if(this.state.message === "sign up successfully"){
          ...
          <div className="content_rgt">
            <div className="register_sec">
              ...
              <ul>
                ...
                <li><span>Email</span><input onChange={this.handleChange} type="text" placeholder="Enter your email" name='Email'required/></li> <p>{this.state.message}</p>
              ...
              <div className="addtnal_acnt">I already have an account.<a href = "http://localhost:3000/login">Login My Account !</a></div>
            </div>
          </div>
