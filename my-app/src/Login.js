      ...
      <div className="content_rgt">
        <div className="login_sec">
          ...
          <ul>
            ...
            <li><input type="submit" defaultValue="Log In" /><a href = "http://localhost:3000/forgot">Forgot Password</a></li>
          </form>
          </ul>
          <div className="addtnal_acnt">I do not have any account yet.<a href = "http://localhost:3000/">Create My Account Now !</a></div>
        </div>
      </div>
